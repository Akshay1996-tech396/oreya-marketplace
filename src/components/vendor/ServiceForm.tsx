...
export default function ServiceForm({
  ...
  const specificationCounterRef = useRef(1);
  ...
  function createSpecificationRow(): SpecificationRow {
    ...
    return {
      id: `specification-${specificationCounterRef.current}`,
      label: "",
      value: "",
    };
  }
  ...
  async function uploadFiles(files: File[]) {
    ...
    try {
      ...
      setImageUrls((currentImages) =>
        Array.from(
          new Set([...currentImages, ...uploadedImages])
        )
      );
  ...
  async function handleSubmit(
    ...
    try {
      ...
      if (!response.ok) {
        setErrorMessage(
          data.message || "Unable to create the service."
        );
        return;
      }
    ...
    >
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Enter the service information, upload supporting images and
          configure customer-facing content.
        </p>
      </div>
      ...
      <section>
        <div className="mb-5 flex flex-col gap-1">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Define the service, provider, pricing and availability.
          </p>
        </div>

        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          <div className="lg:col-span-2">
            <label htmlFor="serviceTitle" className={labelClassName}>
              Service Title <span className="text-error-500">*</span>
            </label>
          ...
          <div>
            <label htmlFor="serviceCategory" className={labelClassName}>
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
            <div>
              <label htmlFor="servicePrice" className={labelClassName}>
      ...
      <section className="mt-8 border-t border-gray-200 pt-7 dark:border-gray-800">
        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Upload high-quality service images. Image paths remain
      ...
      <section className="mt-8 border-t border-gray-200 pt-7 dark:border-gray-800">
        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Add structured details that help customers compare the
              service.
            </p>
          </div>
        ...
        <div className="mt-5">
          <div className="rounded-xl bg-gray-50 p-4 dark:bg-gray-900">
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              Select an uploaded image using the Specifications
              button.
            </p>
      ...
      <section className="mt-8 border-t border-gray-200 pt-7 dark:border-gray-800">
        <div className="mb-5">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Add customer-facing exchange, cancellation and refund policies.
          </p>
        </div>

        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          <div>
            <label htmlFor="exchangePolicy" className={labelClassName}>
              Exchange, Rescheduling or Cancellation Policy
            </label>
            ...
            <textarea
              ...
              onChange={(event) =>
                setExchangePolicy(event.target.value)
              }
          ...
          <div>
            <label htmlFor="refundPolicy" className={labelClassName}>
              Refund Policy
            </label>
            ...
            <textarea
              ...
              value={refundPolicy}
              onChange={(event) =>
                setRefundPolicy(event.target.value)
              }
