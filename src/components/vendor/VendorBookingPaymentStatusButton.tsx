...
type VendorBookingPaymentStatusButtonProps = {
  bookingId: string;
...
export default function VendorBookingPaymentStatusButton({
  bookingId,
  currentPaymentStatus,
}: VendorBookingPaymentStatusButtonProps) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const response = await fetch("/api/vendor/bookings/payment-status", {
        method: "PATCH",
        headers: {
