    ...
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
        <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm font-medium text-brand-500">Vendor</p>
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <input
              ...
              placeholder="Search by code, customer, restaurant, phone, email, or menu"
      ...
      <section className="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        {filteredReservations.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            <table className="min-w-[1250px] divide-y divide-gray-200 dark:divide-gray-800">
