...
export default function AdminServiceForm({
  ...
  async function uploadFiles(files: File[]) {
    ...
    try {
      ...
      console.error("ADMIN_SERVICE_IMAGE_UPLOAD_ERROR", error);
  ...
  async function handleSubmit(
    ...
    try {
      ...
      console.error("ADMIN_CREATE_SERVICE_ERROR", error);
    ...
    >
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Assign ownership and configure marketplace-facing service information.
        </p>
      </div>
      ...
      <section>
        <div className="mb-5">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Keep the service under administrator ownership or assign it to a vendor.
          </p>
        </div>

        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          <div>
            <label htmlFor="serviceOwner" className={labelClassName}>
              Service Owner
            </label>
            ...
            >
              <option value="">Administrator Service / No Vendor</option>
          ...
          <div className="rounded-xl bg-gray-50 p-4 dark:bg-gray-900">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {selectedVendor
                ...
                : "This service will not be linked to a vendor account."}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-8 border-t border-gray-200 pt-7 dark:border-gray-800">
        <div className="mb-5">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Define the service title, category, pricing and
            availability.
          </p>
        </div>
