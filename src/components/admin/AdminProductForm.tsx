 ...
 return {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!response.ok) {
        setErrorMessage(data.message || "Unable to create the product.");
        return;
      }
              ...
              <div className="rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  {selectedVendor
                    ...
                    : "This product will not be linked to a vendor account."}
                </p>
              </div>
            </div>
          </div>
              ...
              {productVariants.map((variant) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
                    <div className="lg:col-span-3 lg:pt-[22px]">
                      <input
                        type="text"
                        value={variant.title}
                        onChange={(event) =>
                    ...
                    <div className="lg:col-span-2 lg:pt-[22px]">
                      <input
                        type="text"
                        value={variant.sku}
                        onChange={(event) =>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Explain the conditions and process for product exchanges."
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Explain the conditions and process for refunds."
                className="min-h-[110px] w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm text-gray-800 focus:border-brand-500 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
              />
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Provide customer-facing information about the brand."
