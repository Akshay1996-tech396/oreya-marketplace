...
export default function AdminServiceEditForm({
  ...
  const initialSpecificationRows =
    getInitialSpecificationRows(service.specifications);
  ...
  async function handleSubmit(
    ...
    try {
      ...
      if (!response.ok) {
        setErrorMessage(
          data.message || "Unable to update the service."
        );
        return;
      }
    ...
    >
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Update ownership and marketplace-facing service information.
        </p>
      </div>
      ...
      <section className="mt-8 border-t border-gray-200 pt-7 dark:border-gray-800">
        <div className="mb-5">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Update the service title, category, pricing and
            availability.
          </p>
        </div>
      ...
      <section className="mt-8 border-t border-gray-200 pt-7 dark:border-gray-800">
        <div className="mb-5">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Update customer-facing policies for this service.
          </p>
        </div>
