...
export async function PUT(
  ...
  try {
      ...
      return NextResponse.json(
        {
          success: false,
          message:
            "Only administrators can update marketplace services.",
        },
        {
          status: 403,
        }
    ...
    let body: UpdateAdminServiceBody;
    ...
    try {
      ...
      body = submittedBody as UpdateAdminServiceBody;
    } catch {
      return NextResponse.json(
        {
          success: false,
    ...
    return NextResponse.json(
      {
        success: false,
        message:
          "Unable to update the service at this time.",
      },
      {
        status: 500,
      }
