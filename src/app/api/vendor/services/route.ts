      ...
      response: NextResponse.json(
        {
          success: false,
          message:
            "Only vendors can create marketplace services.",
        },
        {
          status: 403,
        }
      ...
      response: NextResponse.json(
        {
          success: false,
          message:
            "Only approved vendors can create marketplace services.",
        },
        {
          status: 403,
        }
...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(
      {
        success: false,
        message: "Unable to create the service at this time.",
      },
      {
        status: 500,
      }
