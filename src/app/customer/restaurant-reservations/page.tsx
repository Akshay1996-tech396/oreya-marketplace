...
import CustomerRestaurantReservationsClient from "@/components/customer/CustomerRestaurantReservationsClient";
...
export default async function CustomerRestaurantReservationsPage() {
  ...
  return (
    <CustomerRestaurantReservationsClient
