...
export default async function AdminAppointmentsPage() {
  ...
  const adminOwnedBookings = bookings.filter(
        ...
        <div className="mb-8 flex flex-col justify-between gap-4 border-b border-gray-200 pb-6 md:flex-row md:items-end dark:border-gray-800">
          <div>
            ...
            <p className="mt-3 text-sm text-gray-500 dark:text-gray-400">
              Manage customer appointment bookings for admin-owned services and
        ...
        <section className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
          <div className="border-b border-gray-200 px-5 py-4 dark:border-gray-800">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Review customer, service, owner, date, booking status, and payment
              status.
            </p>
          </div>
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                  {bookings.map((booking) => {
                    const ownerName = booking.vendor
                      ? booking.vendor.businessName
                      : "Admin Service";

                    const ownerEmail = booking.vendor
                      ...
                      >
                        ...
                        <td className="px-5 py-4 text-right align-top">
                          <div className="flex justify-end gap-2">
                            ...
                            <Link
                              href={`/admin/appointments/${booking.id}/edit`}
