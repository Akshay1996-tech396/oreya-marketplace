...
export default async function OrdersReportPage() {
  ...
  const paidOrders = orders.filter((order) => {
    return String(order.paymentStatus) === "PAID";
  }).length;
  ...
  const processingOrders = orders.filter((order) => {
    return String(order.status) === "PROCESSING";
  }).length;
  ...
  const summaryCards = [
    {
      ...
      helper: "All customer product and service orders.",
    },
    {
      label: "Paid Orders",
      value: String(paidOrders),
      helper: "Orders with paid payment status.",
    },
    {
      label: "Pending Orders",
      value: String(pendingOrders),
      helper: "Orders waiting for further processing.",
    },
    {
    ...
    },
    {
      ...
      helper: "Orders cancelled by customer, vendor, or admin.",
    },
    {
      label: "Paid Revenue",
      value: formatMoney(reportCurrency, totalRevenue),
      helper: "Revenue from paid orders only.",
    },
  ];
    ...
    <div>
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Review customer orders, vendor items, selected product variations,
            payment status, and order performance.
          </p>
        </div>
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
          ...
          <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
            Product line items included in orders.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
          ...
          <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
            Service line items included in orders.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Detailed order report with customer, vendor, item, variation, and
              payment information.
            </p>
          </div>
